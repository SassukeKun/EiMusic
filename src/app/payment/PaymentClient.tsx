...
// Interface para dados do formulário de pagamento
interface PaymentFormData {
  phoneNumber: string;
}

// Interface para o objeto de método de pagamento completo
interface FullPaymentMethod {
  id: 'mpesa' | 'paypal';
  name: string;
  description: string;
}
...
export default function PaymentClient() {
  ...
  const handleMethodSelect = (method: FullPaymentMethod) => {
  ...
  const handlePaymentProcess = async () => {
    if (!selectedPlan || !selectedMethod || !paymentData) return
